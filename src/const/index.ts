...
export const BILINGUAL_LIST: Record<Pos | Sow | Polarity | Tense | WordForm | VerbType | AdjType, string> = {
  ...
  past: '过去',
  masu: 'ます形',
  polite_past_form: '敬语过去形',
  polite_negative_form: '敬语否定形',
  polite_past_negative_form: '敬语过去否定形',
  te: 'て形',
  simple_past_form: 'た形',
  negative_form: 'ない形',
  imperative: '命令形',
...
export const INIT_CONFIG: Config = {
  ...
  verb: {
    ...
    kuru: true,
    masu: true,
    polite_past_form: false,
    polite_negative_form: false,
    polite_past_negative_form: false,
    te: true,
